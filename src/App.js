...
function Home() {
  return (
    <div className='hero-container' >
      <div className='hero'><h1 className='restName'>OMNIEATS</h1></div>
      <h1 className='aboutText'>ABOUT</h1>
      <div className='about'>
        <div className='location'>
          <h1 className='margin-bottom'>LOCATION</h1>
        ...
        <div className='hours'>
          <h1 className='margin-bottom'>HOURS</h1>
            <h3>Monday - Friday</h3>
            <h3>8am-8pm</h3>
      ...
      <h1 className='margin-bottom'>Socials</h1>
